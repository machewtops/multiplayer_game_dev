...
if endstate = false {
	...
	else if keyboard_check_pressed(ord("Y")) && card3 == 0{
		card3 = irandom_range(1,11)
	}
	else if keyboard_check_pressed(ord("Y")) && card4 == 0{
		card4 = irandom_range(1,11)
	}
	else if keyboard_check_pressed(ord("Y")) && card5 == 0{
		card5 = irandom_range(1,11)
	}
	else if keyboard_check_pressed(ord("Y")) && card6 == 0{
...
if keyboard_check_pressed(ord("H")) && endstate == false {
	endstate = true;
	DEALERREVEAL2 = true;
}
